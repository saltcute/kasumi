...
export type NormalMessageType = Exclude<
    MessageType,
...
export namespace WebSocket {
    ...
    export namespace Signal {
        ...
        export interface Event {
            s: 0;
            d:
                | NormalMessageEvent<NormalMessageType, GuildType>
                | SystemMessageEvent;
            sn: number;
        }
    ...
    export interface UserDisconnectFromVoiceChannelEvent
        extends SystemMessageEvent {
        channel_type: "GROUP";
        extra: {
            type: "exited_channel";
            body: {
